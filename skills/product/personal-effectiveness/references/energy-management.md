...
# Energy Management - All Guest Insights
...
**Insight:** The guest provides specific tactical advice on managing mental and emotional energy rather than just time to maintain high performance.
...
**Insight:** The guest introduces a specific framework for identifying 'Energy Drivers' and 'Energy Drains' to manage personal productivity, prevent burnout, and design roles.
...
**Insight:** The guest provides a specific framework for auditing a calendar to find 'zone of genius' work and delegating energy-zapping tasks.
...
**Insight:** The guest discusses the specific skill of auditing energy (not just time) and using physical tools (fidgets) to manage the neurological load of remote work.
...
**Insight:** Both the guest and host discuss a specific, tactical framework for career direction based on tracking what 'energizes' vs. 'saps' energy after every interaction or task.
